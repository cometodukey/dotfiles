# Credit to https://github.com/emiflake/nixflake2.0/blob/e9bf282c94627daaf11a08194206b0f1f6b991dc/home-manager/modules/user-theme.nix
...
in
{
    ...
    options.theme = builtins.mapAttrs mkColourOption rec {
        bg = "#222222";
        bg-alt = "#f0f0f0";
        bg-alt1 = "#736f6f";
        base0 = "#f0f0f0";
